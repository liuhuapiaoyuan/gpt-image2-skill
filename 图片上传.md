...
> **安全提示：** 请勿将 ImgBB 的 `key` 写入仓库或提交到 Git。请使用环境变量 `IMGBB_API_KEY`，或使用 `node scripts/imgbb-upload.mjs --key ...`（仅本地/CI 密钥管理）。

f8ab9c60f3854fc6c5afb22584892531

c5c5dd9ce3d53dab143715384a8a6d54
